const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"http://rgproyfinalpy2024.eu.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'http://rgproyfinalpy2024.eu.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
